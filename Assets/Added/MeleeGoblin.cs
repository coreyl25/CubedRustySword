...
public class MeleeGoblin : MonoBehaviour
{
    ...
    public GameObject playerObject; // Manually assign in inspector
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("Player object not assigned in Inspector! Please assign the player GameObject.");
        }
    ...
    {
        // Check if it's the player by comparing the GameObject reference
